    ...
    <div className="stat-card">
      ...
      <div className="pl-3 flex items-start justify-between">
        <div className="flex-1">
          <p className="text-xs font-semibold uppercase tracking-wider mb-2" style={{ color: 'var(--text-dim)', letterSpacing: '0.06em' }}>
            {label}
          </p>
          <p className="text-3xl font-bold leading-none" style={{ color: 'var(--text-main)', letterSpacing: '-0.02em' }}>
            {value ?? '–'}
          </p>
...
function DeliveryRow({ delivery, isDark }) {
  ...
  return (
    <Link
      ...
      className="flex items-center gap-3 p-3 rounded-xl transition-all duration-200 group hover:bg-muted"
    ...
    >
      ...
      <div className="flex-1 min-w-0">
        <p className="text-sm font-mono font-semibold" style={{ color: 'var(--text-main)' }}>
    ...
    <div className="space-y-6 animate-fade-in">
      ...
      <div className="flex items-start justify-between">
        <div>
          ...
          <h1 className="text-2xl lg:text-3xl font-bold" style={{ color: 'var(--text-main)', letterSpacing: '-0.025em' }}>
            {greeting()}, {firstName}! 👋
          </h1>
        ...
        <div className="lg:col-span-2 card">
          <div className="flex items-center justify-between mb-4">
            <div className="flex items-center gap-2">
              ...
              <h2 className="font-semibold text-sm" style={{ color: 'var(--text-main)' }}>Delivery Terbaru</h2>
            </div>
            <Link to="/deliveries"
        ...
        <div className="space-y-4">
          ...
          <div className="card">
            <div className="flex items-center gap-2 mb-4">
              ...
              <h2 className="font-semibold text-sm" style={{ color: 'var(--text-main)' }}>Status Distribusi</h2>
            </div>
